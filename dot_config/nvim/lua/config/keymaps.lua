...
map("n", "<leader>h", ":Pick help<CR>", { desc = "Open help picker" })
-- better up/down
...
map("n", "<leader>d]d", diagnostic_goto(true), { desc = "Next Diagnostic" })
map("n", "<leader>d[d", diagnostic_goto(false), { desc = "Prev Diagnostic" })
map("n", "<leader>d]e", diagnostic_goto(true, "ERROR"), { desc = "Next Error" })
map("n", "<leader>d[e", diagnostic_goto(false, "ERROR"), { desc = "Prev Error" })
map("n", "<leader>d]w", diagnostic_goto(true, "WARN"), { desc = "Next Warning" })
map("n", "<leader>d[w", diagnostic_goto(false, "WARN"), { desc = "Prev Warning" })
-- quit
...
map("n", "<leader>ww", "<C-w>w", { desc = "Focus windows" })
...
-- buffers
map("n", "<leader>b", ":Pick buffers<CR>", { desc = "Open buffer picker" })
